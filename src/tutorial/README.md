...
Lessons 1 and 2 have complete code examples right now. Lessons 3-11 are
...
5. **Lesson 5**: Timing mode, latency modeling, and CPU-model integration hooks

Phase 2 (`C++ + Python`):

6. **Lesson 6**: Bridging C++ models into Python parameters/config
7. **Lesson 7**: Building full systems with Python configuration scripts
8. **Lesson 8**: Using the gem5 standard library composition model
9. **Lesson 9**: Workloads, resources, and checkpoints
10. **Lesson 10**: Debug flags, statistics pipelines, and probe points
11. **Lesson 11**: Capstone hybrid simulator assembly and validation
...
5. Lesson 5: C++ Timing and CPU Hooks (`src/tutorial/lesson05/README.md`)
6. Lesson 6: C++/Python Bridge (`src/tutorial/lesson06/README.md`)
7. Lesson 7: Python Config and Run Loop (`src/tutorial/lesson07/README.md`)
8. Lesson 8: gem5 Stdlib Composition (`src/tutorial/lesson08/README.md`)
9. Lesson 9: Workloads and Checkpoints (`src/tutorial/lesson09/README.md`)
10. Lesson 10: Debug, Stats, and Probes (`src/tutorial/lesson10/README.md`)
11. Lesson 11: Capstone Hybrid Simulator (`src/tutorial/lesson11/README.md`)
